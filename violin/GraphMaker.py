...
def ChooseGraph(state,df,gtype,labels): #iterate through groups in later iteration
    ...
    for group in state:
        ...
        if gtype[0][1] == 'value':
            ti['Value 1']=da.loc['value_1']
            ti['Value 2'] = da.loc['value_2']
            ti['Value 3'] = da.loc['value_3']
            ti['Value 4'] = da.loc['value_4']
            ti['Value 5'] = da.loc['value_5']
            #ti['Income/Debt Ratio'] = da.loc['income/debt']
        if gtype[0][1] == 'cost':
            ti['Cost 1']=da.loc['cost_1']
            ti['Cost 2'] = da.loc['cost_2']
            ti['Cost 3'] = da.loc['cost_3']
            ti['Cost 4'] = da.loc['cost_4']
            ti['Cost 5'] = da.loc['cost_5']
